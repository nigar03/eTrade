    ...
    return (
        <div className='container'>
            <div className="secthree">
                ...
                {lang ==="az"?'Məhsullarımız':'Our Productsy'} 
                </span>

                </span>
                <h2>{lang ==="az"?'Məhsullarımızı araşdırın':'Explore our Products'}</h2>
                <div className="products " >
                    <div class="card ">
                        ...
                        <div className="lala" >
                            <ul style={{ display: "flex", alignItems: 'center', justifyContent: "space-between" }}>
                                ...
                                <li style={{ listStyle: 'none', backgroundColor: '#ff497c', height: '30px', borderRadius: '5px' }}> <a style={{ textDecoration: 'none', color: 'white', fontSize: '15px' }} href="/" >  {lang ==="az"?'Karta Əlavə et':' Add to Card'}</a> </li>
                        ...
                        <div class="card-body">
                            ...
                            <p style={{ color: 'gray' }} class="card-text">  {lang ==="az"?'Yantiti Dəri və Kətan Çantalar':'Yantiti Leather & Canvas Bags'} </p>
                    ...
                    <div class="card" style={{ width: "300px", height: '300px', border: '1px solid white' }}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style={{ color: 'gray' }} >{lang ==="az"?'Səviyyə 20 RGB Albalı':' Level 20 RGB Cherry'}</p>
                            <span style={{ fontWeight: "bold" }}>$29.99</span> <span style={{ color: '#d6d6d6', textDecoration: 'line-through' }}>$49.99</span>
                    ...
                    <div class="card" style={{ width: "300px", height: '300px', border: '1px solid white' }}>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style={{ color: 'gray' }} >{lang ==="az"?'3D™ simsiz qulaqlıq':' 3D™ wireless headset'}</p>
                            <span style={{ fontWeight: "bold" }}>$29.99</span> <span style={{ color: '#d6d6d6', textDecoration: 'line-through' }}>$49.99</span>
